...
g + geom_line(aes(group=Race,linetype = Race )) +  ggtitle("Difference in Average Life Expectency of Genders by Race") + ylab("Average Life Expectancy (Femle-Male)") + xlab("Decade")
